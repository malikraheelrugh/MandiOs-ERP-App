...
import { Shield, Key, Mail, UserCheck, Sun, Moon } from 'lucide-react';
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-[#1E293B] py-8 px-4 border border-[#E2E8F0] dark:border-slate-800 shadow-xl rounded-3xl sm:px-10">
            ...
            <div className="space-y-1">
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  placeholder="e.g. superadmin@mandios.com"
            ...
            <div className="space-y-1">
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <select
                  ...
                  className="block w-full pl-10 pr-4 py-3 bg-[#F8FAFC] dark:bg-[#0F172A] border border-[#CBD5E1] dark:border-slate-800 rounded-xl outline-none text-[#1E293B] dark:text-slate-100 focus:border-[#4F46E5] focus:ring-1 focus:ring-[#4F46E5] transition-all text-xs appearance-none"
                >
                  ...
                  <option value="Customer">{t("Customer (Buyer)")}</option>
                  <option value="Supplier">{t("Supplier (Farmer/Grower)")}</option>
                </select>
              </div>
            </div>
          ...
          <div className="mt-6 pt-5 border-t border-slate-200 dark:border-slate-800 text-center">
            ...
            <div className="grid grid-cols-3 gap-1.5 mt-2.5 text-[10px] text-slate-600 dark:text-slate-300 font-mono">
              <button
                type="button"
                onClick={() => {
                  setEmail('superadmin@mandios.com');
